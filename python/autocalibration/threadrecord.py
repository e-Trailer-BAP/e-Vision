...
# Define output path
output_path = 'data/prototype/video-final'
...
out_files = [
    cv2.VideoWriter(os.path.join(output_path, f'{prefix}-{i+1}.mp4'), fourcc, frame_rate, (frame_width, frame_height))
    for i in range(4)
]
